    ...
    things: [
        ...
        },
        {
            ...
            props: [
                ...
                { name: 'Branch of the addressee', value: 'Vienna 1, common postmark' }
            ]
        },
        {
            image: 'romania-1957',
        ...
        },
        {
            ...
            props: [
                ...
                { name: 'Type', value: 'First Day Cover (FDC), non-postal, fantastic' },
                { name: 'Description', value: 'The envelopes are not postage, the year of issue will be later than 1974. The stamp and postmark are most likely a fake.' },
                { name: 'Picture', value: 'European Bison' },
        ...
        },
        {
            image: 'romania-1977',
            year: '20.03.1977',
            title: 'Protected Birds and Animals of Romania',
            props: [
                { name: 'Country', value: 'Romania' },
                { name: 'Type', value: 'First Day Cover (FDC)' },
                { name: 'Picture', value: 'duck' },
        ...
        },
        {
            ...
            props: [
                ...
                { name: 'Stamp', value: '1976, 4 kopecks, USSR emblem, blue' },
                { name: 'Color', value: 'multicolor' },
                { name: 'Edition', value: 'USSR Ministry of Communications' },
                { name: 'Manufacturing', value: 'Perm Printing Factory of Goznak' },
                { name: 'Size (mm)', value: '114×160' }
        ...
        },
        {
            ...
            props: [
                ...
                { name: 'Artist', value: 'V. Skabijene' },
                { name: 'Numbers', value: '1a, 1b, 1c, 1d' },
                { name: 'Stamp', value: 'bison picture' },
                { name: 'Postmark', value: 'mastic color is black, bison picture' },
                { name: 'Color', value: 'multicolor' },
                { name: 'Size (mm)', value: '114×162' },
        ...
        },
        {
            ...
            title: 'Animals of Belarus',
            props: [
                { name: 'Country', value: 'Belarus' },
                { name: 'Type', value: 'First Day Cover (FDC)' },
                { name: 'Picture', value: 'forest landscape' },
                { name: 'Artist', value: 'A. Fedin' },
                { name: 'Number', value: '?' },
                { name: 'Stamp', value: 'bison picture (1995)' },
                { name: 'Postmark', value: 'mastic color is black, deer and flora image' },
                { name: 'Color', value: 'green' },
                { name: 'Size (mm)', value: '?' },
                { name: 'Commemorative Cancellation', value: 'Minsk' }
            ]
        },
        {
            ...
            props: [
                ...
                { name: 'Type', value: 'First Day Cover (FDC)' },
                { name: 'Picture', value: 'flora' },
                { name: 'Designer', value: 'Vladimír Machaj' },
                { name: 'Engraver', value: 'Martin Činovský' },
                { name: 'Print', value: 'metallography from steel engravings and gravure printing' },
        ...
        },
        {
            image: 'poland-1996',
            year: '04.12.1996',
            title: 'Protected animals. Bison',
            props: [
                { name: 'Country', value: 'Poland' },
                { name: 'Type', value: 'First Day Cover (FDC)' },
                { name: 'Picture', value: 'types of forest in Belovezhskaya Pushcha' },
                { name: 'Stamp', value: 'bison picture' },
        ...
        },
        {
            ...
            props: [
                { name: 'Country', value: 'Poland' },
                { name: 'Type', value: 'First Day Cover (FDC)' },
                { name: 'Picture', value: 'bison profile' },
        ...
        },
        {
            ...
            year: '03.10.2009',
            title: '600 years of conservation of Belovezhskaya Pushcha',
            props: [
                { name: 'Country', value: 'Belarus' },
                { name: 'Type', value: 'First Day Cover (FDC)' },
        ...
        },
        {
            image: 'belarus-2012',
            year: '20.01.2012',
            title: '20th anniversary of the establishment of diplomatic relations between the Republic of Belarus and the People\'s Republic of China',
            props: [
                { name: 'Country', value: 'Belarus' },
                { name: 'Type', value: 'First Day Cover (FDC)' },
        ...
        },
        {
            image: 'belarus-2017',
            year: '15.03.2017',
            title: '25th anniversary of the establishment of diplomatic relations between the Republic of Belarus and the Republic of Poland',
            props: [
                { name: 'Country', value: 'Belarus' },
                { name: 'Type', value: 'First Day Cover (FDC)' },
                { name: 'Picture', value: 'picture of the border between Poland and Belarus in the area of Belovezhskaya Pushcha, forest' },
        ...
        },
        {
            image: 'ceska-2017',
            year: '06.09.2017',
            title: 'Nature Conservancy - Zoos II',
            props: [
                { name: 'Country', value: 'Czech Republic' },
                { name: 'Type', value: 'First Day Cover (FDC)' },
                { name: 'Picture', value: 'deer picture' },
        ...
        },
        {
            image: 'belarus-2018',
            year: '18.10.2018',
            title: 'Joint issue of the Republic of Belarus and the Kyrgyz Republic. 25th anniversary of the establishment of diplomatic relations',
            props: [
                { name: 'Country', value: 'Belarus' },
                { name: 'Type', value: 'First Day Cover (FDC)' },
